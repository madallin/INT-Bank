...
class _TransactionHistoryScreenState extends State<TransactionHistoryScreen>
  ...
  Future<void> _fetchTransactions() async {
    ...
    try {
      final client = _createHttpClient();
      final uri = Uri.parse(
          '${AppConfig.baseUrl}/users/${widget.userId}/accounts/${widget.accountId}/transactions');
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const PageTitle(
                                  title: 'Istoric tranzacții',
                                  subtitle:
                                      'Vizualizează ultimele tranzacții efectuate în contul tău',
                                ),
                              ],
                            ),
                          ),
                          Expanded(
                            child: _transactions.isEmpty
                                ? const EmptyStatePlaceholder(
                                    title:
                                        'Nu există tranzacții recente realizate în acest cont bancar.',
                                  )
                                : ListView(
                                    padding:
